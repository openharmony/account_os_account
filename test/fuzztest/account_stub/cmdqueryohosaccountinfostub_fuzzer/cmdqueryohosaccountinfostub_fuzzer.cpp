...
#include "cmdqueryohosaccountinfostub_fuzzer.h"
...
bool CmdQueryOhosAccountInfoStubFuzzTest(const uint8_t* data, size_t size)
{
    ...
    uint32_t code = static_cast<uint32_t>(AccountMgrInterfaceCode::QUERY_OHOS_ACCOUNT_INFO);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::CmdQueryOhosAccountInfoStubFuzzTest(data, size);
    return 0;
}
