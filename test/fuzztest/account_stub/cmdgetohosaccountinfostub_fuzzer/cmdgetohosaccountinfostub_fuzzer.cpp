...
#include "cmdgetohosaccountinfostub_fuzzer.h"
...
const std::u16string ACCOUNT_TOKEN = u"ohos.accountfwk.IAccount";
    ...
    bool CmdGetOhosAccountInfoStubFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        uint32_t code = static_cast<uint32_t>(IAccount::GET_OHOS_ACCOUNT_INFO);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::CmdGetOhosAccountInfoStubFuzzTest(data, size);
    return 0;
}
