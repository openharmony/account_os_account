...
#ifndef OS_ACCOUNT_SERVICES_ACCOUNTMGR_INCLUDE_IAM_MGR_STUB_H
#define OS_ACCOUNT_SERVICES_ACCOUNTMGR_INCLUDE_IAM_MGR_STUB_H
...
#endif  // OS_ACCOUNT_SERVICES_ACCOUNTMGR_INCLUDE_IAM_MGR_STUB_H