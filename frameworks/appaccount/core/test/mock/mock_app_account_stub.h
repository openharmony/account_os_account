...
#ifndef OS_ACCOUNT_FRAMEWORKS_APPACCOUNT_CORE_TEST_MOCK_MOCK_APP_ACCOUNT_STUB_H
#define OS_ACCOUNT_FRAMEWORKS_APPACCOUNT_CORE_TEST_MOCK_MOCK_APP_ACCOUNT_STUB_H
...
#endif  // OS_ACCOUNT_FRAMEWORKS_APPACCOUNT_CORE_TEST_MOCK_MOCK_APP_ACCOUNT_STUB_H
