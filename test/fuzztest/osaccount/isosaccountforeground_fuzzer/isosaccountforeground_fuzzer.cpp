...
#include "isosaccountforeground_fuzzer.h"
...
void IsOsAccountForegroundWith2ArgsFuzzTest(const uint8_t *data, size_t size)
{
    ...
    OsAccountManager::IsOsAccountForeground(testId, isForeground);
}
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::IsOsAccountForegroundWith2ArgsFuzzTest(data, size);
    OHOS::IsOsAccountForegroundWith3ArgsFuzzTest(data, size);
    return 0;
}
