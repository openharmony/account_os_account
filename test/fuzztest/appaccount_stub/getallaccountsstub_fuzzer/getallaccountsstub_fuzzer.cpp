...
bool GetAllAccountsStubFuzzTest(const uint8_t* data, size_t size)
{
    ...
    uint32_t code = static_cast<uint32_t>(IAppAccountIpcCode::COMMAND_GET_ALL_ACCOUNTS);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::GetAllAccountsStubFuzzTest(data, size);
    return 0;
}
