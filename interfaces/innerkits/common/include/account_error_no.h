...
constexpr ErrCode ACCOUNT_COMMON_ERR_OFFSET = ErrCodeOffset(SUBSYS_ACCOUNT, ACCOUNT_MODULE_COMMON); // 4194304
enum {
    ...
    ERR_ACCOUNT_COMMON_ACCOUNT_IS_RESTRICTED,
    ERR_ACCOUNT_COMMON_DATA_NO_SPACE,
    ERR_ACCOUNT_COMMON_DLOPEN_ERROR,
    ERR_ACCOUNT_COMMON_DLSYM_ERROR,
    ERR_ACCOUNT_COMMON_EXCEPTION_ERROR,
    ERR_ACCOUNT_COMMON_SECRET_CHECK,
    ERR_ACCOUNT_COMMON_CONNECT_DISPLAY_MANAGER_SERVICE_ERROR,
    ERR_ACCOUNT_COMMON_CROSS_DISPLAY_ACTIVE_ERROR,
    ERR_ACCOUNT_COMMON_REMOTE_DIED,
    ERR_ACCOUNT_COMMON_BUSY,
    ERR_ACCOUNT_COMMON_OPERATION_FAIL,
    ERR_ACCOUNT_COMMON_TEE_PERMISSION_DENIED,
    ERR_ACCOUNT_COMMON_TEE_USER_TOKEN_INVALID,
    ERR_ACCOUNT_COMMON_TEE_USER_TOKEN_EXPIRED,
    ERR_ACCOUNT_COMMON_TEE_REACH_LIMIT,
    ERR_ACCOUNT_COMMON_TEE_ACCOUNT_NOT_EXIST,
    ERR_ACCOUNT_COMMON_TEE_NOT_ALLOW_RECOVERY,
    ERR_ACCOUNT_COMMON_TEE_USER_ROLE_FAIL,
    ERR_OS_ACCOUNT_SUBPROFILE_LIMIT,
    ERR_OS_ACCOUNT_SUBPROFILE_NOT_FOUND,
    ERR_OS_ACCOUNT_SUBPROFILE_RESTRICTED,
    ERR_OS_ACCOUNT_SUBPROFILE_IS_FOREGROUND,
    ERR_OS_ACCOUNT_SUBPROFILE_HAS_ACTIVE_SESSION,
    ERR_OS_ACCOUNT_SUBPROFILE_DISTRIBUTE_ACC_ALREADY_BOUND,
    ERR_ACCOUNT_COMMON_SYSTEM_SERVICE_EXCEPTION,
};

// Error code for AccountMgr
constexpr ErrCode ACCOUNT_ACCOUNTMGR_ERR_OFFSET = ErrCodeOffset(SUBSYS_ACCOUNT, ACCOUNT_MODULE_ACCOUNTMGR); // 4259840
enum {
...
constexpr ErrCode ACCOUNT_DATADEAL_ERR_OFFSET = ErrCodeOffset(SUBSYS_ACCOUNT, ACCOUNT_MODULE_DATADEAL); // 4325376
enum {
...
constexpr ErrCode ACCOUNT_IACCOUNT_ERR_OFFSET = ErrCodeOffset(SUBSYS_ACCOUNT, ACCOUNT_MODULE_IACCOUNT); // 4390912
enum {
...
constexpr ErrCode APPACCOUNT_KIT_ERR_OFFSET = ErrCodeOffset(SUBSYS_ACCOUNT, ACCOUNT_MODULE_APPACCOUNT_KIT); // 4456448
enum {
...
constexpr ErrCode APPACCOUNT_SERVICE_ERR_OFFSET =
    ErrCodeOffset(SUBSYS_ACCOUNT, ACCOUNT_MODULE_APPACCOUNT_SERVICE); // 4521984
enum {
...
constexpr ErrCode ACCOUNT_OSACCOUNT_KIT_ERR_OFFSET =
    ErrCodeOffset(SUBSYS_ACCOUNT, ACCOUNT_MODULE_OSACCOUNT_KIT); // 4587520
enum {
...
constexpr ErrCode ACCOUNT_OSACCOUNT_SERVICE_ERR_OFFSET =
    ErrCodeOffset(SUBSYS_ACCOUNT, ACCOUNT_MODULE_OSACCOUNT_SERVICE); // 4653056
enum {
    ...
    ERR_OSACCOUNT_SERVICE_INNER_ACCOUNT_ALREADY_EXIST_ERROR,
    ...
    ERR_OSACCOUNT_SERVICE_IAM_ERASE_USER_FAILED,
    ERR_OSACCOUNT_SERVICE_STORAGE_STOP_USER_FAILED,
    ERR_OSACCOUNT_SERVICE_SAMGR_USER_STATE_FAILED,
    //ANIMATION
    ERR_OSACCOUNT_SERVICE_INNER_ANIMATION_POLL_ERROR,
    ERR_OSACCOUNT_SERVICE_INNER_ANIMATION_TIMEOUT,
    ERR_OSACCOUNT_SERVICE_INNER_ANIMATION_UNEXPECTED_EVENT,
    ERR_OSACCOUNT_SERVICE_INNER_ANIMATION_READ_ERROR,
    // Bind domain account with os account
    ERR_OSACCOUNT_SERVICE_INNER_OS_ACCOUNT_ALREADY_BOUND,
    ERR_OSACCOUNT_SERVICE_INNER_DOMAIN_ACCOUNT_ALREADY_BOUND,
    ERR_OSACCOUNT_SERVICE_CONTROL_MAX_TYPE_CAN_CREATE_ERROR,
    // Code end, do not modify.
    ERR_OS_ACCOUNT_SERVICE_CODE_END,
};

// Error code for ACCOUNT_IAM_KIT
constexpr ErrCode ACCOUNT_IAM_KIT_ERR_OFFSET =
    ErrCodeOffset(SUBSYS_ACCOUNT, ACCOUNT_MODULE_ACCOUNT_IAM_KIT); // 4718592
enum {
    ...
    ERR_ACCOUNT_IAM_AUTH_TOKEN_INVALID,
    ERR_ACCOUNT_IAM_GET_SECUSER_FAILED,
    ERR_ACCOUNT_IAM_GET_CREDINFO_FAILED,
    ERR_ACCOUNT_IAM_NO_CREDENTIAL,
};

// Error code for OHOSACCOUNT_SERVICE
constexpr ErrCode ACCOUNT_OHOSACCOUNT_SERVICE_ERR_OFFSET =
    ErrCodeOffset(SUBSYS_ACCOUNT, ACCOUNT_MODULE_OHOSACCOUNT_SERVICE); // 4784128
enum {
...
constexpr ErrCode DOMAIN_ACCOUNT_ERR_OFFSET =
    ErrCodeOffset(SUBSYS_ACCOUNT, ACCOUNT_MODULE_DOMAIN_ACCOUNT_SERVICE); // 4849664
enum {
    ...
    ERR_DOMAIN_ACCOUNT_NOT_SUPPORT,
...
constexpr ErrCode ACCOUNT_OHOSACCOUNT_KIT_ERR_OFFSET =
    ErrCodeOffset(SUBSYS_ACCOUNT, ACCOUNT_MODULE_OHOSACCOUNT_KIT); // 4915200
enum {
...
constexpr ErrCode AUTHORIZATION_ERR_OFFSET =
    ErrCodeOffset(SUBSYS_ACCOUNT, ACCOUNT_MODULE_AUTHORIZATION); // 4980736
enum {
    ...
    ERR_AUTHORIZATION_UPDATE_INFO_ERROR,
    ERR_AUTHORIZATION_INVALID_ADMIN_ACCOUNT_OR_PASSWORD,
    ERR_AUTHORIZATION_NO_CACHE,
    ERR_AUTHORIZATION_EXTENSION_ILLEGAL,
    ERR_AUTHORIZATION_KERNEL_NOTIFY_FAILED,
    ERR_AUTHORIZATION_KERNEL_OPEN_FAILED,
    ERR_AUTHORIZATION_KERNEL_DEVICE_NOT_FOUND,
    ERR_AUTHORIZATION_KERNEL_QUERY_FAILED,
    ERR_AUTHORIZATION_KERNEL_SET_FAILED,
    ERR_AUTHORIZATION_APP_DIED,
};
...
enum IAMResultCode : int32_t {
    ...
    ERR_IAM_AUTH_TOKEN_CHECK_FAILED = 15,
    ERR_IAM_AUTH_TOKEN_EXPIRED = 16,
    ERR_IAM_NO_VALID_CREDENTIAL = 18,
    ...
    ERR_IAM_CHECK_SYSTEM_APP_FAILED = 1007,
    ERR_IAM_CROSS_DEVICE_COMMUNICATION_FAILED = 1008,
    ERR_IAM_CROSS_DEVICE_CAPABILITY_NOT_SUPPORT = 1009,
...
enum JSErrorCode {
    ...
    ERR_JS_AUTHORIZATION_DENIED = 204,
    ...
    ERR_JS_FOREGROUND_OS_ACCOUNT_NOT_FOUND = 12300017,
    ERR_JS_DISPLAY_NOT_FOUND = 12300018,
    ERR_JS_CROSS_DISPLAY_ACTIVATION_NOT_SUPPORTED = 12300019,
    ERR_JS_OS_ACCOUNT_ALREADY_BOUND = 12300021,
    ERR_JS_DOMAIN_ACCOUNT_ALREADY_BOUND = 12300022,
    ERR_JS_ACCOUNT_TYPE_MAX_CAN_CREATED = 12300023,
    ERR_JS_OS_ACCOUNT_SUBPROFILE_NOT_FOUND = 12300401,
    ERR_JS_OS_ACCOUNT_SUBPROFILE_LIMIT_REACHED = 12300402,
    ERR_JS_OS_ACCOUNT_SUBPROFILE_RESTRICTED = 12300403,
    ERR_JS_OS_ACCOUNT_SUBPROFILE_DELETE_FOREGROUND_RESTRICTED = 12300404,
    ERR_JS_OS_ACCOUNT_SUBPROFILE_SWITCH_HAS_ACTIVE_SESSION = 12300405,
    ERR_JS_OS_ACCOUNT_SUBPROFILE_DISTRIBUTE_ACC_ALREADY_BOUND = 12300406,

    // 12300090 ~ 12300099 for iam distributed scenario
    ERR_JS_ACCOUNT_CROSS_DEVICE_CAPABILITY_NOT_SUPPORT = 12300090,
    ERR_JS_ACCOUNT_CROSS_DEVICE_COMMUNICATION_FAILED = 12300091,
    ...
    ERR_JS_CREDENTIAL_NO_LONGER_VALID = 12300120,

    ERR_JS_DOMAIN_PLUGIN_ALREADY_REGISTERED = 12300201,
    ERR_JS_SERVER_UNREACHABLE = 12300211,
    ERR_JS_SERVER_CONFIG_NOT_FOUND = 12300212,
    ERR_JS_SERVER_CONFIG_ALREADY_EXISTS = 12300213,
    ERR_JS_SERVER_CONFIG_ASSOCIATED_ACCOUNT = 12300214,
    ERR_JS_SERVER_CONFIG_UPPER_LIMIT = 12300215,
    ...
    ERR_JS_AUTHORIZATION_INTERACTION_NOT_ALLOWED = 12300302,
    ERR_JS_AUTHORIZATION_SERVICE_BUSY = 12300304,
};
