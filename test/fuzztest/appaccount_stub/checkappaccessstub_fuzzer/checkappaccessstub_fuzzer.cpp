...
bool CheckAppAccessStubFuzzTest(const uint8_t* data, size_t size)
{
    ...
    uint32_t code = static_cast<uint32_t>(IAppAccountIpcCode::COMMAND_CHECK_APP_ACCESS);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::CheckAppAccessStubFuzzTest(data, size);
    return 0;
}
