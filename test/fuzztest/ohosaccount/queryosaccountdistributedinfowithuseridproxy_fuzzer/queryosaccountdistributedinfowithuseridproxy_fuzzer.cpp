...
#include "queryosaccountdistributedinfowithuseridproxy_fuzzer.h"
...
namespace OHOS {
bool QueryOsAccountDistributedInfoWithUserIdProxyFuzzTest(const uint8_t* data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::QueryOsAccountDistributedInfoWithUserIdProxyFuzzTest(data, size);
    return 0;
}
