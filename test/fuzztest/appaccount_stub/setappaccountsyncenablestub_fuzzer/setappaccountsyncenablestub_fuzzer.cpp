...
#include "setappaccountsyncenablestub_fuzzer.h"
...
bool SetAppAccountSyncEnableStubFuzzTest(const uint8_t* data, size_t size)
{
    ...
    uint32_t code = static_cast<uint32_t>(IAppAccountIpcCode::COMMAND_SET_APP_ACCOUNT_SYNC_ENABLE);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::SetAppAccountSyncEnableStubFuzzTest(data, size);
    return 0;
}
