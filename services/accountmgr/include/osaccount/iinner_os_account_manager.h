...
public:
    ...
    ErrCode DeactivateOsAccount(const int id, const bool isStopStorage = true) override;
...
private:
    ...
    ErrCode SendMsgForAccountDeactivate(OsAccountInfo &osAccountInfo, const bool isStopStorage = true);
