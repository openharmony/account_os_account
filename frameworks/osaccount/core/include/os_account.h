...
public:
    ...
    ErrCode SetOsAccountType(const int id, const OsAccountType& type, const SetOsAccountTypeOptions& options);
    ...
    ErrCode GetUnlockedOsAccountLocalIds(std::vector<int32_t>& ids);
