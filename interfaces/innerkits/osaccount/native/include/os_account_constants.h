...
const char OPERATION_DEACTIVATE[] = "deactivate";
const char OPERATION_DEACTIVATE_ALL[] = "deactivateAll";
const char OPERATION_CREATE[] = "create";
const char OPERATION_CREATE_WITH_FULL_INFO[] = "createWithFullInfo";
const char OPERATION_UPDATE_OS_ACCOUNT[] = "updateOsAccount";
...
#endif
constexpr int32_t SUB_PROFILE_ID_INITIAL_VALUE = 0;
