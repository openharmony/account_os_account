...
napi_value NapiAppAccount::AddAccount(napi_env env, napi_callback_info cbInfo)
{
    ...
    ACCOUNT_LOGI("Parsing completed, name = %{public}s, extraInfo = %{public}s", asyncContext->name.c_str(),
...
napi_value NapiAppAccount::DisableAppAccess(napi_env env, napi_callback_info cbInfo)
{
    ...
    ACCOUNT_LOGI("Parsing completed, name = %{public}s, bundleName = %{public}s", asyncContext->name.c_str(),
    ...
    NAPI_CALL(env,
        napi_create_async_work(
            ...
            [](napi_env env, void *data) {
                ...
                AppAccountAsyncContext *asyncContext = (AppAccountAsyncContext*)data;
                asyncContext->errCode = AppAccountManager::DisableAppAccess(asyncContext->name,
                    asyncContext->bundleName);
    ...
    NAPI_CALL(env,
        napi_create_async_work(
            ...
            [](napi_env env, void *data) {
                ...
                AppAccountAsyncContext *asyncContext = (AppAccountAsyncContext*)data;
                asyncContext->errCode = AppAccountManager::EnableAppAccess(asyncContext->name,
                    asyncContext->bundleName);
    ...
    NAPI_CALL(env,
        napi_create_async_work(
            ...
            [](napi_env env, void *data) {
                ...
                AppAccountAsyncContext *asyncContext = (AppAccountAsyncContext*)data;
                asyncContext->errCode = AppAccountManager::CheckAppAccountSyncEnable(asyncContext->name,
                    asyncContext->result);
...
napi_value NapiAppAccount::SetAccountCredential(napi_env env, napi_callback_info cbInfo)
{
    ...
    ACCOUNT_LOGI("Parsing completed, name = %{public}s, credentialType = %{public}s, credential = %{public}s",
        asyncContext->name.c_str(), asyncContext->credentialType.c_str(), asyncContext->credential.c_str());
    ...
    NAPI_CALL(env,
        napi_create_async_work(
            ...
            [](napi_env env, void *data) {
                ...
                AppAccountAsyncContext *asyncContext = (AppAccountAsyncContext*)data;
                asyncContext->errCode = AppAccountManager::SetAccountCredential(asyncContext->name,
                    asyncContext->credentialType, asyncContext->credential);
...
napi_value NapiAppAccount::SetAccountExtraInfo(napi_env env, napi_callback_info cbInfo)
{
    ...
    asyncContext->callbackRef = nullptr;
    ParseContextWithExInfo(env, cbInfo, asyncContext);
    ACCOUNT_LOGI("Parameter parsing completed, name = %{public}s, extraInfo = %{public}s", asyncContext->name.c_str(),
        asyncContext->extraInfo.c_str());
    ...
    NAPI_CALL(env,
        napi_create_async_work(
            ...
            [](napi_env env, void *data) {
                ...
                AppAccountAsyncContext *asyncContext = (AppAccountAsyncContext*)data;
                asyncContext->errCode = AppAccountManager::SetAccountExtraInfo(asyncContext->name,
                    asyncContext->extraInfo);
    ...
    NAPI_CALL(env,
        napi_create_async_work(
            ...
            [](napi_env env, void *data) {
                ...
                AppAccountAsyncContext *asyncContext = (AppAccountAsyncContext*)data;
                asyncContext->errCode = AppAccountManager::SetAppAccountSyncEnable(asyncContext->name,
                    asyncContext->isEnable);
    ...
    NAPI_CALL(env,
        napi_create_async_work(
            ...
            [](napi_env env, void *data) {
                ...
                AppAccountAsyncContext *asyncContext = (AppAccountAsyncContext*)data;
                asyncContext->errCode = AppAccountManager::SetAssociatedData(asyncContext->name, asyncContext->key,
                    asyncContext->value);
    ...
    NAPI_CALL(env,
        napi_create_async_work(
            ...
            [](napi_env env, void *data) {
                ...
                AppAccountAsyncContext *asyncContext = (AppAccountAsyncContext*)data;
                asyncContext->errCode = AppAccountManager::GetAccountCredential(asyncContext->name,
                    asyncContext->credentialType, asyncContext->credential);
    ...
    NAPI_CALL(env,
        napi_create_async_work(
            ...
            [](napi_env env, void *data) {
                ...
                AppAccountAsyncContext *asyncContext = (AppAccountAsyncContext*)data;
                asyncContext->errCode = AppAccountManager::GetAccountExtraInfo(asyncContext->name,
                    asyncContext->extraInfo);
    ...
    NAPI_CALL(env,
        napi_create_async_work(
            ...
            [](napi_env env, void *data) {
                ...
                AppAccountAsyncContext *asyncContext = (AppAccountAsyncContext*)data;
                asyncContext->errCode = AppAccountManager::GetAssociatedData(asyncContext->name, asyncContext->key,
                    asyncContext->value);
...
napi_value NapiAppAccount::Subscribe(napi_env env, napi_callback_info cbInfo)
{
    ...
    NAPI_CALL(env,
        napi_create_async_work(
            ...
            (void*)asyncContextForOn, &asyncContextForOn->work));
