...
void AccountCommandDeleteTest::SetUp(void) __attribute__((no_sanitize("cfi")))
{
 ...
 * @tc.require:
 */
HWTEST_F(AccountCommandDeleteTest, Acm_Command_Delete_1000, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(AccountCommandDeleteTest, Acm_Command_Delete_1100, TestSize.Level1)
{
