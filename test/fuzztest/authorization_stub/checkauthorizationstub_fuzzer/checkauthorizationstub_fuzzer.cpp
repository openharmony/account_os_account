 ...
 */
#include "checkauthorizationstub_fuzzer.h"
#include <cstddef>
#include <string>
#include <vector>
...
bool CheckAuthorizationStubFuzzTest(const uint8_t* data, size_t size)
{
    ...
    if (!dataTemp.WriteBool(isAuthorized)) {
        return false;
    }
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::CheckAuthorizationStubFuzzTest(data, size);
    return 0;
}
