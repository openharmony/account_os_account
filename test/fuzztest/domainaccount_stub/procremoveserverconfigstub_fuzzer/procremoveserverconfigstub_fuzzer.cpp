...
#include "procremoveserverconfigstub_fuzzer.h"
...
bool ProcRemoveServerConfigStubFuzzTest(const uint8_t* data, size_t size)
{
    ...
    uint32_t code = static_cast<uint32_t>(IDomainAccountIpcCode::COMMAND_REMOVE_SERVER_CONFIG);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ProcRemoveServerConfigStubFuzzTest(data, size);
    return 0;
}
