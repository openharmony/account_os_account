...
ErrCode OsAccountStandardInterface::SendToStorageAccountCreate(OsAccountInfo &osAccountInfo)
{
    ...
    int err = proxy->PrepareAddUser(osAccountInfo.GetLocalId(), StorageManager::CRYPTO_FLAG_EL1 | StorageManager::CRYPTO_FLAG_EL2);
...
ErrCode OsAccountStandardInterface::SendToStorageAccountRemove(OsAccountInfo &osAccountInfo)
{
    ...
    int err = proxy->RemoveUser(osAccountInfo.GetLocalId(), StorageManager::CRYPTO_FLAG_EL1 | StorageManager::CRYPTO_FLAG_EL2);
