...
#include "procregisterpluginstub_fuzzer.h"
...
const std::u16string ACCOUNT_TOKEN = u"ohos.accountfwk.IDomainAccount";
    ...
    bool ProcRegisterPluginStubFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        uint32_t code = static_cast<uint32_t>(DomainAccountInterfaceCode::REGISTER_PLUGIN);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ProcRegisterPluginStubFuzzTest(data, size);
    return 0;
}
