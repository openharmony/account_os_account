...
napi_value AuthTypeConstructor(napi_env env)
{
    ...
    NAPI_CALL(env, napi_create_int32(env, static_cast<int32_t>(AuthType::CUSTOM_AUTH), &custom));
    ...
    NAPI_CALL(env, napi_set_named_property(env, authType, "CUSTOM", custom));
