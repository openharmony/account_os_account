...
#include "procsetosaccountnamestub_fuzzer.h"
#include <string>
#include <thread>
#include <vector>
#include "fuzz_data.h"
...
bool ProcSetOsAccountNameStubFuzzTest(const uint8_t *data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::ProcSetOsAccountNameStubFuzzTest(data, size);
    return 0;
}
