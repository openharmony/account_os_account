...
bool DelCredStubFuzzTest(const uint8_t *data, size_t size)
{
    ...
    uint32_t code = static_cast<uint32_t>(IAccountIAMIpcCode::COMMAND_DEL_CRED);
...
void NativeTokenGet()
{
    ...
    infoInstance.processName = "DEL_CRED";
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::DelCredStubFuzzTest(data, size);
    return 0;
}
