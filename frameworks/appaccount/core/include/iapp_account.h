...
#ifndef OS_ACCOUNT_FRAMEWORKS_APPACCOUNT_CORE_INCLUDE_IAPP_ACCOUNT_H
#define OS_ACCOUNT_FRAMEWORKS_APPACCOUNT_CORE_INCLUDE_IAPP_ACCOUNT_H
...
#endif  // OS_ACCOUNT_FRAMEWORKS_APPACCOUNT_CORE_INCLUDE_IAPP_ACCOUNT_H
