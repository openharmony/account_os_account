...
#ifndef OS_ACCOUNT_SERVICES_ACCOUNTMGR_INCLUDE_IINNER_APP_ACCOUNT_H
#define OS_ACCOUNT_SERVICES_ACCOUNTMGR_INCLUDE_IINNER_APP_ACCOUNT_H
...
namespace OHOS {
namespace AccountSA {
class IInnerAppAccount {
public:
    virtual ErrCode AddAccount(
        const std::string &name, const std::string &extraInfo, const std::string &bundleName) = 0;
    virtual ErrCode DeleteAccount(const std::string &name, const std::string &bundleName) = 0;

    virtual ErrCode GetAccountExtraInfo(
        const std::string &name, std::string &extraInfo, const std::string &bundleName) = 0;
    virtual ErrCode SetAccountExtraInfo(
        const std::string &name, const std::string &extraInfo, const std::string &bundleName) = 0;

    virtual ErrCode EnableAppAccess(
        const std::string &name, const std::string &authorizedApp, const std::string &bundleName) = 0;
    virtual ErrCode DisableAppAccess(
        const std::string &name, const std::string &authorizedApp, const std::string &bundleName) = 0;

    virtual ErrCode CheckAppAccountSyncEnable(
        const std::string &name, bool &syncEnable, const std::string &bundleName) = 0;
    virtual ErrCode SetAppAccountSyncEnable(
        const std::string &name, const bool &syncEnable, const std::string &bundleName) = 0;
    ...
    virtual ErrCode SetAssociatedData(
        const std::string &name, const std::string &key, const std::string &value, const std::string &bundleName) = 0;
    ...
    virtual ErrCode SetAccountCredential(const std::string &name, const std::string &credentialType,
        const std::string &credential, const std::string &bundleName) = 0;
    ...
    virtual ErrCode SubscribeAppAccount(const AppAccountSubscribeInfo &subscribeInfo,
...
#endif  // OS_ACCOUNT_SERVICES_ACCOUNTMGR_INCLUDE_IINNER_APP_ACCOUNT_H
