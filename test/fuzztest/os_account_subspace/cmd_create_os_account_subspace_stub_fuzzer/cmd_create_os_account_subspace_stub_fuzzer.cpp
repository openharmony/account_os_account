...
#include "cmd_create_os_account_subspace_stub_fuzzer.h"
...
bool CmdCreateOsAccountSubspaceStubFuzzTest(const uint8_t* data, size_t size)
{
    ...
    uint32_t code = static_cast<uint32_t>(IOsAccountSubProfileIpcCode::COMMAND_CREATE_OS_ACCOUNT_SUB_PROFILE);
...
void NativeTokenGet()
{
    ...
    infoInstance.processName = "CmdCreateOsAccountSubspaceStub";
...
{
    OHOS::CmdCreateOsAccountSubspaceStubFuzzTest(data, size);
    return 0;
}
