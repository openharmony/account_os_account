...
#ifndef OS_ACCOUNT_SERVICES_ACCOUNTMGR_TEST_MOCK_APP_ACCOUNT_MOCK_APP_ACCOUNT_MANAGER_SERVICE_H
#define OS_ACCOUNT_SERVICES_ACCOUNTMGR_TEST_MOCK_APP_ACCOUNT_MOCK_APP_ACCOUNT_MANAGER_SERVICE_H
...
namespace OHOS {
namespace AccountSA {
class MockAppAccountManagerService : public AppAccountManagerService {
public:
    MockAppAccountManagerService();
    ~MockAppAccountManagerService() override;
...
#endif // HAS_CES_PART
    DISALLOW_COPY_AND_MOVE(MockAppAccountManagerService);
};
}  // namespace AccountSA
}  // namespace OHOS
