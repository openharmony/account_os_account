...
HWTEST_F(AccountErrorCodeConvertTest, AccountErrorCodeConvertTest001, TestSize.Level0)
{
    ...
    EXPECT_EQ(ConvertToJSErrCode(ERR_APPACCOUNT_SERVICE_ASSOCIATED_DATA_OVER_SIZE), ERR_JS_CUSTOM_DATA_NUMBER_REACH_LIMIT);
    ...
    EXPECT_EQ(ConvertToJSErrCode(ERR_APPACCOUNT_KIT_NO_SPECIFIED_SUBSCRIBER_HAS_BEEN_REGISTERED), ERR_JS_LISTENER_NOT_REGISTERED);
    EXPECT_EQ(ConvertToJSErrCode(ERR_APPACCOUNT_SERVICE_OAUTH_AUTHENTICATOR_NOT_EXIST), ERR_JS_ACCOUNT_AUTHENTICATOR_NOT_EXIST);
    ...
    EXPECT_EQ(ConvertToJSErrCode(ERR_APPACCOUNT_SERVICE_OAUTH_AUTHENTICATOR_CALLBACK_NOT_EXIST), ERR_JS_SESSION_NOT_EXIST);
    ...
    EXPECT_EQ(ConvertToJSErrCode(ERR_APPACCOUNT_SERVICE_AUTHENTICATOR_MANAGER_PTR_IS_NULLPTR), ERR_JS_ACCOUNT_AUTHENTICATOR_SERVICE_EXCEPTION);
    EXPECT_EQ(ConvertToJSErrCode(ERR_APPACCOUNT_SERVICE_OAUTH_SERVICE_EXCEPTION), ERR_JS_ACCOUNT_AUTHENTICATOR_SERVICE_EXCEPTION);
...
HWTEST_F(AccountErrorCodeConvertTest, AccountErrorCodeConvertTest002, TestSize.Level0)
{
    ...
    EXPECT_EQ(ConvertToJSErrCode(ERR_OSACCOUNT_SERVICE_INNER_ACCOUNT_ALREADY_ACTIVE_ERROR), ERR_JS_ACCOUNT_ALREADY_ACTIVATED);

    EXPECT_EQ(ConvertToJSErrCode(ERR_OSACCOUNT_SERVICE_CONTROL_MAX_CAN_CREATE_ERROR), ERR_JS_ACCOUNT_NUMBER_REACH_LIMIT);

    EXPECT_EQ(ConvertToJSErrCode(ERR_OSACCOUNT_SERVICE_MANAGER_NOT_ENABLE_MULTI_ERROR), ERR_JS_MULTI_USER_NOT_SUPPORT);

    EXPECT_EQ(ConvertToJSErrCode(ERR_OSACCOUNT_SERVICE_MANAGER_CREATE_OSACCOUNT_TYPE_ERROR), ERR_JS_ACCOUNT_TYPE_NOT_SUPPORT);
    ...
    EXPECT_EQ(ConvertToJSErrCode(ERR_OSACCOUNT_KIT_NO_SPECIFIED_SUBSCRIBER_HAS_BEEN_REGISTERED), ERR_JS_LISTENER_NOT_REGISTERED);

    EXPECT_EQ(ConvertToJSErrCode(ERR_OSACCOUNT_SERVICE_PERMISSION_DENIED), ERR_JS_PERMISSION_DENIED);

    EXPECT_EQ(ConvertToJSErrCode(ERR_OSACCOUNT_SERVICE_CONTROL_UPDATE_FILE_NOT_EXISTS_ERROR), ERR_JS_SYSTEM_SERVICE_EXCEPTION);
}
