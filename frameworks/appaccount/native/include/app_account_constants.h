...
const std::string KEY_BOOL_RESULT = "booleanResult";
...
const std::string PREFIX_APPACCESS = "acc";
const std::string PREFIX_APPACCESS_INV = "acc_inv";
const std::string PREFIX_ASSOCIATED_DATA = "ass_data";
