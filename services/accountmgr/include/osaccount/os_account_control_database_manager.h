 ...
 */
#ifndef OS_ACCOUNT_SERVICES_ACCOUNTMGR_INCLUDE_OSACCOUNT_OS_ACCOUNT_CONTROL_DATABSE_MANAGER_H
#define OS_ACCOUNT_SERVICES_ACCOUNTMGR_INCLUDE_OSACCOUNT_OS_ACCOUNT_CONTROL_DATABSE_MANAGER_H
#include <memory>
...
namespace OHOS {
namespace AccountSA {
class OsAccountControlDatabaseManager : public IOsAccountControl {
public:
    OsAccountControlDatabaseManager();
    virtual ~OsAccountControlDatabaseManager();
