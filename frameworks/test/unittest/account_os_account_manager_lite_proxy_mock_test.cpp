...
constexpr uint32_t COMMAND_GET_SUB_PROFILE_ID_BY_LOCAL_APP = 26;
constexpr uint32_t COMMAND_GET_SUB_PROFILE_ID_BY_TOKEN = 27;
constexpr uint32_t COMMAND_GET_FOREGROUND_SUB_PROFILE_ID_IN_INT_OUT_INT = 20;
constexpr uint32_t COMMAND_GET_LOCAL_ID_FOR_SUB_PROFILE = 23;
