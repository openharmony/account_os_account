...
enum {
    ...
    ERR_OS_ACCOUNT_SERVICE_INNER_SEND_CE_ACCOUNT_START_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INNER_SEND_CE_ACCOUNT_STOP_ERROR,
    ...
    // 4653144
    ERR_OS_ACCOUNT_SERVICE_INTERFACE_TO_CES_ACCOUNT_CREATE_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INTERFACE_TO_CES_ACCOUNT_DELETE_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INTERFACE_TO_CES_ACCOUNT_START_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INTERFACE_TO_CES_ACCOUNT_STOP_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INTERFACE_TO_AMS_ACCOUNT_START_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INTERFACE_TO_AMS_ACCOUNT_STOP_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INTERFACE_TO_BMS_ACCOUNT_CREATE_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INTERFACE_TO_BMS_ACCOUNT_DELETE_ERROR,
