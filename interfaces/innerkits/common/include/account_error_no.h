...
enum {
    ...
    ERR_OS_ACCOUNT_SUBSPACE_LIMIT,
    ERR_OS_ACCOUNT_SUBSPACE_NOT_FOUND,
    ERR_OS_ACCOUNT_SUBSPACE_RESTRICTED,
    ERR_OS_ACCOUNT_SUBSPACE_IS_FOREGROUND,
    ERR_OS_ACCOUNT_SUBSPACE_HAS_ACTIVE_SESSION,
...
enum JSErrorCode {
    ...
    ERR_JS_OS_ACCOUNT_SUBSPACE_NOT_FOUND = 12300401,
    ERR_JS_OS_ACCOUNT_SUBSPACE_LIMIT_REACHED = 12300402,
    ERR_JS_OS_ACCOUNT_SUBSPACE_RESTRICTED = 12300403,
    ERR_JS_OS_ACCOUNT_SUBSPACE_DELETE_FOREGROUND_RESTRICTED = 12300404,
    ERR_JS_OS_ACCOUNT_SUBSPACE_SWITCH_HAS_ACTIVE_SESSION = 12300405,
