...
bool CloseSessionStubFuzzTest(const uint8_t *data, size_t size)
{
    ...
    uint32_t code = static_cast<uint32_t>(IAccountIAMIpcCode::COMMAND_CLOSE_SESSION);
...
void NativeTokenGet()
{
    ...
    infoInstance.processName = "CLOSE_SESSION";
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::CloseSessionStubFuzzTest(data, size);
    return 0;
}
