...
#include "getosaccountforegroundsubprofileidstub_fuzzer.h"
...
bool GetOsAccountForegroundSubProfileIdStubFuzzTest(const uint8_t* data, size_t size)
{
    ...
    uint32_t code = static_cast<uint32_t>(
        IAccountIpcCode::COMMAND_GET_OS_ACCOUNT_FOREGROUND_SUB_PROFILE_ID);
    ...
    code = static_cast<uint32_t>(
        IAccountIpcCode::COMMAND_GET_OS_ACCOUNT_FOREGROUND_SUB_PROFILE_ID_IN_INT_OUT_INT);
...
void NativeTokenGet()
{
    ...
    infoInstance.processName = "GetOsAccountForegroundSubProfileIdStub";
...
{
    OHOS::GetOsAccountForegroundSubProfileIdStubFuzzTest(data, size);
    return 0;
}
