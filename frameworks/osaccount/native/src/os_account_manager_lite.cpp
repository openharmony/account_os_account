...
constexpr uint32_t COMMAND_GET_OS_ACCOUNT_SUB_PROFILE_ID_APP = 26;
constexpr uint32_t COMMAND_GET_OS_ACCOUNT_SUB_PROFILE_ID_TOKEN = 27;
constexpr uint32_t COMMAND_GET_OS_ACCOUNT_SUB_PROFILE_INDEX = 28;
constexpr uint32_t COMMAND_GET_OS_ACCOUNT_FOREGROUND_SUB_PROFILE_ID_IN_INT_OUT_INT = 20;
constexpr uint32_t COMMAND_GET_OS_ACCOUNT_LOCAL_ID_FOR_SUB_PROFILE = 23;
