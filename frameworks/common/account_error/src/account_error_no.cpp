...
static const std::unordered_map<uint32_t, std::string> g_errorStringMap = {
    ...
    {ERR_JS_OS_ACCOUNT_SUBPROFILE_LIMIT_REACHED,
        "The number of sub-profiles under the OS account has reached limit"},
    {ERR_JS_OS_ACCOUNT_SUBPROFILE_RESTRICTED,
        "Restricted OS account sub-profile"},
    {ERR_JS_OS_ACCOUNT_SUBPROFILE_DELETE_FOREGROUND_RESTRICTED,
        "The foreground sub-profile of the OS account cannot be deleted"},
    {ERR_JS_OS_ACCOUNT_SUBPROFILE_SWITCH_HAS_ACTIVE_SESSION,
        "The foreground sub-profile bound to a logged-in "
...
const std::unordered_map<int32_t, int32_t> errorMap = {
    ...
    { ERR_OS_ACCOUNT_SUBPROFILE_LIMIT, ERR_JS_OS_ACCOUNT_SUBPROFILE_LIMIT_REACHED },
    { ERR_OS_ACCOUNT_SUBPROFILE_NOT_FOUND, ERR_JS_OS_ACCOUNT_SUBPROFILE_NOT_FOUND },
    { ERR_OS_ACCOUNT_SUBPROFILE_RESTRICTED, ERR_JS_OS_ACCOUNT_SUBPROFILE_RESTRICTED },
    { ERR_OS_ACCOUNT_SUBPROFILE_IS_FOREGROUND, ERR_JS_OS_ACCOUNT_SUBPROFILE_DELETE_FOREGROUND_RESTRICTED },
    { ERR_OS_ACCOUNT_SUBPROFILE_HAS_ACTIVE_SESSION, ERR_JS_OS_ACCOUNT_SUBPROFILE_SWITCH_HAS_ACTIVE_SESSION },
