...
const std::string STRING_KEY_OUT_OF_RANGE(1200, '1');  // length 1200
const std::string STRING_VALUE = "value";
const std::string STRING_VALUE_OUT_OF_RANGE(1200, '1');  // length 1200
const std::string STRING_CREDENTIAL_TYPE = "password";
const std::string STRING_CREDENTIAL_TYPE_OUT_OF_RANGE(1200, '1');  // length 1200
const std::string STRING_AUTHORIZED_APP_OUT_OF_RANGE(1200, '1');  // length 1200
const std::string STRING_CREDENTIAL = "1024";
const std::string STRING_CREDENTIAL_OUT_OF_RANGE(1200, '1');  // length 1200
const std::string STRING_TOKEN = "1024";
const std::string STRING_TOKEN_OUT_OF_RANGE(1200, '1');  // length 1200
const std::string STRING_OWNER = "com.example.owner";
const std::string STRING_AUTH_TYPE = "all";
const std::string STRING_OUT_OF_RANGE(1200, '1');  // length 1200
...
/**
 * @tc.name: AppAccountManager_ExecuteRequest_0100
 * @tc.desc: Test func ExecuteRequest callback is nullptr.
 * @tc.type: FUNC
...
/**
 * @tc.name: AppAccountManager_ExecuteRequest_0200
 * @tc.desc: Test func ExecuteRequest the caller's information is invalid.
 * @tc.type: FUNC
 * @tc.require: issueI7AVZ5
 */
HWTEST_F(AppAccountManagerTest, AppAccountManager_ExecuteRequest_0200, TestSize.Level1)
{
    AccountCapabilityRequest request;
...
/**
 * @tc.name: AppAccountManager_ExecuteRequest_0300
 * @tc.desc: Test func ExecuteRequest the caller's information is invalid.
 * @tc.type: FUNC
 * @tc.require: issueI7AVZ5
 */
HWTEST_F(AppAccountManagerTest, AppAccountManager_ExecuteRequest_0300, TestSize.Level1)
{
    AccountCapabilityRequest request;
    request.bundleName = STRING_BUNDLE_NAME;
    request.abilityName = STRING_ABILITY_NAME;
    sptr<IAppAccountAuthorizationExtensionCallback> callback =
        new (std::nothrow) MockAppAccountAuthorizationExtensionCallbackStub();
    ASSERT_NE(callback, nullptr);
