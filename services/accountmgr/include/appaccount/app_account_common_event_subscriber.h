...
#ifndef OS_ACCOUNT_FRAMEWORKS_APPACCOUNT_CORE_INCLUDE_APP_ACCOUNT_COMMON_EVENT_SUBSCRIBER_H
#define OS_ACCOUNT_FRAMEWORKS_APPACCOUNT_CORE_INCLUDE_APP_ACCOUNT_COMMON_EVENT_SUBSCRIBER_H
...
public:
    ...
    ~AppAccountCommonEventSubscriber();
...
#endif  // OS_ACCOUNT_FRAMEWORKS_APPACCOUNT_CORE_INCLUDE_APP_ACCOUNT_COMMON_EVENT_SUBSCRIBER_H
