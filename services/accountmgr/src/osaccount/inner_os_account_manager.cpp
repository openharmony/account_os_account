                                                          ...
                                                          const uint64_t displayId)
{
    ...
    ErrCode errCode = SendToAMSAccountStart(osAccountInfo, displayId);
    if (errCode != ERR_OK) {
        return errCode;
    }
    if (oldId != localId) {
    ...
    uint64_t displayId)
{
    ...
    ErrCode errCode = OsAccountInterface::SendToAMSAccountStart(osAccountInfo, callbackFunc);
    if (errCode != ERR_OK) {
