...
#include "cmd_delete_os_account_subspace_stub_fuzzer.h"
...
bool CmdDeleteOsAccountSubspaceStubFuzzTest(const uint8_t* data, size_t size)
{
    ...
    uint32_t code = static_cast<uint32_t>(IOsAccountSubProfileIpcCode::COMMAND_DELETE_OS_ACCOUNT_SUB_PROFILE);
...
void NativeTokenGet()
{
    ...
    infoInstance.processName = "CmdDeleteOsAccountSubspaceStub";
...
{
    OHOS::CmdDeleteOsAccountSubspaceStubFuzzTest(data, size);
    return 0;
}
