...
enum {
    ...
    ERR_APPACCOUNT_KIT_INVALID_REQUEST,
    ...
    ERR_APPACCOUNT_KIT_WRITE_PARCELABLE_RESULT,
    ...
    ERR_APPACCOUNT_KIT_READ_STRING_AUTH_TYPE,
    ERR_APPACCOUNT_KIT_READ_STRING_BUNDLE_NAME,
    ERR_APPACCOUNT_KIT_READ_STRING_ABILITY_NAME,
    /* AppAccountEventStub */
    ERR_APPACCOUNT_KIT_READ_PARCELABLE_VECTOR_ACCOUNT_INFO,
    ERR_APPACCOUNT_KIT_READ_PARCELABLE_OPTIONS,
};
...
enum {
    ...
    ERR_OS_ACCOUNT_KIT_CREATE_OS_ACCOUNT_FOR_DOMAIN_ERROR,
    ERR_OS_ACCOUNT_KIT_WRITE_DOMAIN_ERROR,
    ERR_OS_ACCOUNT_KIT_WRITE_DOMAIN_ACCOUNT_NAME_ERROR,
    ...
    ERR_OSACCOUNT_KIT_WRITE_BOOL_ISOSACCOUNT_VERIFIED_ERROR,
...
enum {
    ...
    ERR_OS_ACCOUNT_SERVICE_MANAGER_NOT_ENABLE_MULTI_ERROR,
    ERR_OS_ACCOUNT_SERVICE_MANAGER_NAME_SIZE_EMPTY_ERROR,
    ERR_OS_ACCOUNT_SERVICE_MANAGER_NAME_SIZE_OVERFLOW_ERROR,
    ERR_OS_ACCOUNT_SERVICE_MANAGER_PHOTO_SIZE_OVERFLOW_ERROR,
    ERR_OS_ACCOUNT_SERVICE_MANAGER_DOMAIN_SIZE_OVERFLOW_ERROR,
    ERR_OS_ACCOUNT_SERVICE_MANAGER_ID_ERROR,
    ERR_OS_ACCOUNT_SERVICE_MANAGER_CANNOT_HIDE_INTERFACE_ERROR,
    ERR_OS_ACCOUNT_SERVICE_MANAGER_CREATE_OSACCOUNT_TYPE_ERROR,
    // 4653078
    ...
    ERR_OS_ACCOUNT_SERVICE_INNER_GET_SERIAL_NUMBER_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INNER_GET_OSACCOUNT_ID_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INNER_STOP_OSACCOUNT_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INNER_GET_TTPE_CONSTRAINTS_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INNER_ACCOUNT_IS_UNVERIFIED_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INNER_GET_ALL_OSACCOUNTINFO_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INNER_ACCOUNT_ALREAD_ACTIVE_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INNER_ACCOUNT_STOP_ACTIVE_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INNER_SEND_AM_ACCOUNT_START_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INNER_SEND_AM_ACCOUNT_STOP_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INNER_SEND_BM_ACCOUNT_CREATE_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INNER_SEND_BM_ACCOUNT_DELE_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INNER_SEND_IAM_ACCOUNT_DELE_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INNER_SEND_CE_ACCOUNT_CREATE_ERROR,
    ERR_OS_ACCOUNT_SERVICE_PERMISSION_DENIED,
    ERR_OS_ACCOUNT_SERVICE_INNER_SEND_CE_ACCOUNT_DELE_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INNER_SEND_AM_ACCOUNT_SWITCH_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INNER_SEND_CE_ACCOUNT_SWITCH_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INNER_REMOVE_ACCOUNT_ACTIVED_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INNER_CANNOT_REMOVE_ADMIN_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INNER_DONNOT_HAVE_PHOTO_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INNER_SER_CONSTRAINTS_ERROR,
    ...
    ERR_OS_ACCOUNT_SERVICE_CONTROL_SET_ACCOUNT_LIST_ERROR,
    ERR_OS_ACCOUNT_SERVICE_CONTROL_PHOTO_STR_ERROR,
    ERR_OS_ACCOUNT_SERVICE_CONTROL_ID_CANNOT_CREATE_ERROR,
    ERR_OS_ACCOUNT_SERVICE_CONTROL_CANNOT_DELETE_ID_ERROR,
    ...
    ERR_OS_ACCOUNT_SERVICE_CONTROL_INSERT_OS_ACCOUNT_FILE_ERROR,
    ...
    // 4653151
    ERR_OS_ACCOUNT_SERVICE_INTERFACE_TO_CE_ACCOUNT_CREATE_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INTERFACE_TO_CE_ACCOUNT_DELETE_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INTERFACE_TO_CE_ACCOUNT_SWITCHED_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INTERFACE_TO_AM_ACCOUNT_START_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INTERFACE_TO_AM_ACCOUNT_STOP_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INTERFACE_TO_BM_ACCOUNT_CREATE_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INTERFACE_TO_BM_ACCOUNT_DELETE_ERROR,
    ERR_OS_ACCOUNT_SERVICE_SUBSCRIBE_GET_EVENT_HANDLE_ERROR,
    ERR_OS_ACCOUNT_SERVICE_STANDARD_BYTE_STRING_ERROR,
    ERR_OS_ACCOUNT_SERVICE_STANDARD_CREATE_IMAGE_SOURCE_ERROR,
    ERR_OS_ACCOUNT_SERVICE_STANDARD_CREATE_PIXEL_MAP_ERROR,
    ERR_OS_ACCOUNT_SERVICE_OS_FILE_GET_CONFIG_ERROR,
    ERR_OS_ACCOUNT_SERVICE_OS_FILE_GET_CONSTRATIONS_LITS_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INTERFACE_TO_STORAGE_ACCOUNT_CREATE_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INTERFACE_TO_STORAGE_ACCOUNT_REMOVE_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INTERFACE_TO_STORAGE_ACCOUNT_START_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INTERFACE_TO_STORAGE_ACCOUNT_STOP_ERROR,
    ERR_OS_ACCOUNT_SERVICE_INNER_ACCOUNT_OPERATING_ERROR,
};
}  // namespace OHOS
